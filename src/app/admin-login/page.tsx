  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{backgroundColor: 'var(--background)'}}>
      <div className="w-full max-w-md">
        {/* Header Card */}
        <div className="rounded-t-3xl p-8 text-center shadow-lg" style={{background: 'linear-gradient(to right, var(--primary-light-blue), var(--secondary-light-blue))'}}>
          <div className="mb-4">
        ...
        {/* Form Card */}
        <div className="bg-white rounded-b-3xl p-8 shadow-xl border-t-4" style={{borderColor: 'var(--accent-light-blue)'}}>
          {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-3 flex items-center" style={{color: 'var(--accent-light-blue)'}}>
                  <svg
                    className="w-5 h-5"
                    fill="none"
                    stroke="currentColor"
            ...
            <button
              ...
              style={{background: 'linear-gradient(to right, var(--accent-light-blue), var(--secondary-light-blue))'}}
            >
              {loading ? (
