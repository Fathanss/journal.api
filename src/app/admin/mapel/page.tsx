...
export default function FramesPage() {
    ...
    return (
        <div>
            <h1 className="text-2xl font-bold mb-6 text-gray-800">Mapel</h1>
            ...
            <OffcanvasForm
                ...
                title={currentFrame.id ? "Edit mapel" : "Create mapel"}
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => setCurrentFrame({ ...currentFrame, description: e.target.value })}
                                className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-fuchsia-500"
                            />
                        </div>
                    </div>
